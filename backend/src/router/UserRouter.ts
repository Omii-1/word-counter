...
class UserRoutes extends BaseRoutes {
    public routes(): void {
        ...
        this.router.patch("/update-password/:userId", authenticationToken, validate(updatePasswordSchema) as any, UserController.changePassword);
        ...
        this.router.delete("/delete-user/:userId", authenticationToken, UserController.deleteUser);
